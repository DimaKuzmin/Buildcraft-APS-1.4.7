...
public class GuiAPSSlider extends GuiButton
{
    ...
    public GuiAPSSlider(int id, int xPos, int yPos, int width, int height, int notchTexXPos, int notchTexYPos, int notchTexWidth, int notchTexHeight, String notchTex, String label, float startingValue)
    {
